...
class __TwigTemplate_234f63c2b66c34e778eb5e440643e4e0cc657062ad208f191e3959ee7d13fec8 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        echo "        <a href=\"http://symfony.com/\">
            ...
            <span>
                ";
        // line 9
        if ($this->getAttribute($this->getContext($context, "collector"), "applicationname", array())) {
            // line 10
            echo "                    ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "applicationname", array()), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "applicationversion", array()), "html", null, true);
            echo "
                ";
        } else {
            // line 12
            echo "                    ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "symfonyversion", array()), "html", null, true);
            echo "
                ";
        }
        // line 14
    ...
    ";
        ...
        echo "            <div class=\"sf-toolbar-info-piece sf-toolbar-info-php\">
                ...
                <span>";
        // line 42
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "phpversion", array()), "html", null, true);
        echo "</span>
            </div>
        ...
        // line 46
        echo (($this->getAttribute($this->getContext($context, "collector"), "hasxdebug", array())) ? ("green") : ("red"));
        echo "\">xdebug</span>
                <span class=\"sf-toolbar-status sf-toolbar-status-";
        // line 47
        echo (($this->getAttribute($this->getContext($context, "collector"), "hasaccelerator", array())) ? ("green") : ("red"));
        echo "\">accel</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>PHP SAPI</b>
                <span>";
        // line 51
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "sapiName", array()), "html", null, true);
        echo "</span>
            </div>
        ";
    ...
    ";
        ...
        echo (($this->getAttribute($this->getContext($context, "collector"), "debug", array())) ? ("green") : ("red"));
        ...
        ";
        // line 63
        if ((("n/a" != $this->getAttribute($this->getContext($context, "collector"), "appname", array())) || ("n/a" != $this->getAttribute($this->getContext($context, "collector"), "env", array())))) {
            // line 64
            echo "            <span class=\"sf-toolbar-info-piece-additional-detail\">
                <span class=\"sf-toolbar-info-with-delimiter\">";
            // line 65
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "appname", array()), "html", null, true);
            echo "</span>
                <span>";
            // line 66
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "env", array()), "html", null, true);
            echo "</span>
            </span>
        ";
        }
        ...
        // line 72
        echo "            ";
        if (("n/a" != $this->getAttribute($this->getContext($context, "collector"), "appname", array()))) {
            // line 73
            echo "                <div class=\"sf-toolbar-info-piece\">
                    <b>Name</b>
                    <span>";
        ...
        // line 78
        echo "            ";
        if (("n/a" != $this->getAttribute($this->getContext($context, "collector"), "env", array()))) {
            // line 79
            echo "                <div class=\"sf-toolbar-info-piece\">
                    <b>Environment</b>
                    <span>";
        ...
        // line 84
        echo "            ";
        if (("n/a" != $this->getAttribute($this->getContext($context, "collector"), "debug", array()))) {
            // line 85
            echo "                <div class=\"sf-toolbar-info-piece\">
                    <b>Debug</b>
                    <span class=\"";
            ...
            echo twig_escape_filter($this->env, $this->getContext($context, "debug_status_class"), "html", null, true);
            echo "\">";
            echo (($this->getAttribute($this->getContext($context, "collector"), "debug", array())) ? ("en") : ("dis"));
            echo "abled</span>
                </div>
            ";
        }
        ...
        if ($this->getContext($context, "profiler_url")) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "token", array()), "html", null, true);
            echo "</a>
                    ";
        } else {
            // line 96
...
";
    ...
    <table>
        ...
        if (("n/a" != $this->getAttribute($this->getContext($context, "collector"), "debug", array()))) {
            ...
            echo "            <tr>
                ...
                <td>";
            // line 143
            echo (($this->getAttribute($this->getContext($context, "collector"), "debug", array())) ? ("enabled") : ("disabled"));
            echo "</td>
            </tr>
        ";
        }
    ...
    <table>
        ...
        <tr>
            ...
            <td>";
        // line 160
        echo (($this->getAttribute($this->getContext($context, "collector"), "hasxdebug", array())) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            ...
            <td>";
        // line 164
        echo (($this->getAttribute($this->getContext($context, "collector"), "hasaccelerator", array())) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            <th>XCache</th>
            <td>";
        // line 168
        echo (($this->getAttribute($this->getContext($context, "collector"), "hasxcache", array())) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            <th>APC</th>
            <td>";
        // line 172
        echo (($this->getAttribute($this->getContext($context, "collector"), "hasapc", array())) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            <th>Zend OPcache</th>
            <td>";
        // line 176
        echo (($this->getAttribute($this->getContext($context, "collector"), "haszendopcache", array())) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            <th>EAccelerator</th>
            <td>";
        // line 180
        echo (($this->getAttribute($this->getContext($context, "collector"), "haseaccelerator", array())) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
    ...
    ";
        // line 188
        if ($this->getAttribute($this->getContext($context, "collector"), "bundles", array())) {
            // line 189
        ...
        <table>
            ...
            ";
            // line 195
            $context["bundles"] = $this->getAttribute($this->getContext($context, "collector"), "bundles", array());
            // line 196
            echo "            ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                <td>";
                // line 199
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "bundles"), $context["name"], array(), "array"), "html", null, true);
                echo "</td>
            </tr>
            ";
            }
