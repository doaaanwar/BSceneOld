...
class __TwigTemplate_db97b4906654624f779d495b1f37edd2a4fd9c06cb781f343f97ad81eefb3a60 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_e4885466d1b47c3695ba2f9a12db45ba180000765e4acbd4d4007d486cc85e28"] = $this;
        // line 5
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 19
        echo "    ";
        $context["duration"] = ((twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "events", array()))) ? (sprintf("%.0f ms", $this->getAttribute($this->getContext($context, "collector"), "duration", array()))) : ("n/a"));
        // line 20
        echo "    ";
        ob_start();
        // line 21
...
";
    ...
    ";
        // line 42
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "events", array()))) {
            // line 43
            echo "        ";
    ...
    public function block_panelContent($context, array $blocks = array())
    {
        ...
        <table>
            <tr>
                ...
                <td>";
        // line 57
        echo twig_escape_filter($this->env, sprintf("%.0f", $this->getAttribute($this->getContext($context, "collector"), "duration", array())), "html", null, true);
        echo " ms</td>
            </tr>
            <tr>
                ...
                <td>";
        // line 61
        echo twig_escape_filter($this->env, sprintf("%.0f", $this->getAttribute($this->getContext($context, "collector"), "inittime", array())), "html", null, true);
        echo " ms</td>
            </tr>
            <tr>
                <th>Threshold</th>
    ...
    <h3>
        ";
        // line 71
        echo (($this->getAttribute($this->getContext($context, "profile"), "parent", array())) ? ("Request") : ("Main Request"));
        echo "
        <small>
            - ";
        // line 73
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events", array()), "__section__", array()), "duration", array()), "html", null, true);
        echo " ms
            ";
        // line 74
        if ($this->getAttribute($this->getContext($context, "profile"), "parent", array())) {
            // line 75
            echo "                - <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_profiler", array("token" => $this->getAttribute($this->getAttribute($this->getContext($context, "profile"), "parent", array()), "token", array()), "panel" => "time")), "html", null, true);
            echo "\">parent</a>
            ";
        }
        // line 77
    ...
    ";
        // line 80
        echo $context["__internal_e4885466d1b47c3695ba2f9a12db45ba180000765e4acbd4d4007d486cc85e28"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events", array()), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children", array()))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                ...
                <small> - ";
                // line 87
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "events"), "__section__", array()), "duration", array()), "html", null, true);
                echo " ms</small>
            </h3>

            ";
                // line 90
                echo $context["__internal_e4885466d1b47c3695ba2f9a12db45ba180000765e4acbd4d4007d486cc85e28"]->getdisplay_timeline(("timeline_" . $this->getAttribute($context["child"], "token", array())), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
    ...
    <script>";
        ...
        var requests_data = {
            \"max\": ";
        // line 400
        echo twig_escape_filter($this->env, sprintf("%F", $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events", array()), "__section__", array()), "endtime", array())), "js", null, true);
        echo ",
            \"requests\": [
";
        // line 402
        echo $context["__internal_e4885466d1b47c3695ba2f9a12db45ba180000765e4acbd4d4007d486cc85e28"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events", array()), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events", array()), "__section__", array()), "origin", array()));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 407
                echo $context["__internal_e4885466d1b47c3695ba2f9a12db45ba180000765e4acbd4d4007d486cc85e28"]->getdump_request_data($this->getAttribute($context["child"], "token", array()), $context["child"], $this->getAttribute($this->getAttribute($context["child"], "getcollector", array(0 => "time"), "method"), "events", array()), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events", array()), "__section__", array()), "origin", array()));
...
";
    ...
    public function getdump_request_data($__token__ = null, $__profile__ = null, $__events__ = null, $__origin__ = null)
    {
        ...
        try {
            // line 447
            $context["__internal_821bc9e00772ebdb60af37d4ef79408f94de5c742cb7006fe5cccee94fab297c"] = $this;
            // line 448
            echo "                {
                    \"id\": \"";
            // line 449
            ...
            echo "\",
                    \"left\": ";
            // line 450
            echo twig_escape_filter($this->env, sprintf("%F", ($this->getAttribute($this->getAttribute($this->getContext($context, "events"), "__section__", array()), "origin", array()) - $this->getContext($context, "origin"))), "js", null, true);
            echo ",
                    \"events\": [
";
            // line 452
            echo $context["__internal_821bc9e00772ebdb60af37d4ef79408f94de5c742cb7006fe5cccee94fab297c"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
