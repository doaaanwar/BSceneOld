...
class __TwigTemplate_33dc432f19caa1e2dcf75d4a0fc72cfba99d4a17b4baeaf43b2a7cc9508e35ab extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 6
        echo "    ";
        if ((($this->getAttribute($this->getContext($context, "collector"), "counterrors", array()) || $this->getAttribute($this->getContext($context, "collector"), "countdeprecations", array())) || $this->getAttribute($this->getContext($context, "collector"), "countscreams", array()))) {
            // line 7
            echo "        ";
            ob_start();
            // line 8
            ...
            ";
            // line 9
            if ($this->getAttribute($this->getContext($context, "collector"), "counterrors", array())) {
                // line 10
                echo "                ";
                $context["status_color"] = "red";
                // line 11
                echo "            ";
            } elseif ($this->getAttribute($this->getContext($context, "collector"), "countdeprecations", array())) {
                // line 12
                echo "                ";
            ...
            // line 14
            echo "            ";
            $context["error_count"] = (($this->getAttribute($this->getContext($context, "collector"), "counterrors", array()) + $this->getAttribute($this->getContext($context, "collector"), "countdeprecations", array())) + $this->getAttribute($this->getContext($context, "collector"), "countscreams", array()));
            // line 15
        ...
        ";
            ...
            if ($this->getAttribute($this->getContext($context, "collector"), "counterrors", array())) {
                ...
                // line 21
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "counterrors", array()), "html", null, true);
                echo "</span>
                </div>
            ";
            }
            // line 24
            echo "            ";
            if ($this->getAttribute($this->getContext($context, "collector"), "countdeprecations", array())) {
                // line 25
                echo "                <div class=\"sf-toolbar-info-piece\">
                    <b>Deprecated Calls</b>
                    <span class=\"sf-toolbar-status sf-toolbar-status-yellow\">";
                // line 27
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "countdeprecations", array()), "html", null, true);
                echo "</span>
                </div>
            ";
            }
            // line 30
            echo "            ";
            if ($this->getAttribute($this->getContext($context, "collector"), "countscreams", array())) {
                // line 31
                echo "                <div class=\"sf-toolbar-info-piece\">
                    <b>Silenced Errors</b>
                    <span class=\"sf-toolbar-status sf-toolbar-status\">";
                // line 33
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "countscreams", array()), "html", null, true);
                echo "</span>
                </div>
            ";
            }
...
";
    ...
    ";
        // line 57
        $context["priority"] = $this->getAttribute($this->getAttribute($this->getContext($context, "request"), "query", array()), "get", array(0 => "priority", 1 => 0), "method");
        // line 58
        echo "
    <table>
        <tr>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "collector"), "priorities", array()));
        foreach ($context['_seq'] as $context["value"] => $context["level"]) {
            // line 69
            echo "                            ";
            if (( !$this->getContext($context, "priority") && ($context["value"] > 100))) {
                // line 70
                echo "                                ";
            ...
            echo "\"";
            echo ((($context["value"] == $this->getContext($context, "priority"))) ? (" selected") : (""));
            echo ">";
    ...
    ";
        // line 89
        if ($this->getAttribute($this->getContext($context, "collector"), "logs", array())) {
            // line 90
            echo "        <ul class=\"alt\">
            ";
            // line 91
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "collector"), "logs", array()));
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
                if (((($this->getContext($context, "priority") >= 0) && ($this->getAttribute($context["log"], "priority", array()) >= $this->getContext($context, "priority"))) || (($this->getContext($context, "priority") < 0) && ((($this->getAttribute($this->getAttribute($context["log"], "context", array(), "any", false, true), "type", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($context["log"], "context", array(), "any", false, true), "type", array()), 0)) : (0)) == $this->getContext($context, "priority"))))) {
                    // line 92
                    echo "                <li class=\"";
    ...
    public function getdisplay_message($__log_index__ = null, $__log__ = null)
    {
        ...
        try {
            // line 108
            echo "    ";
            if ((($this->getAttribute($this->getAttribute($this->getContext($context, "log", true), "context", array(), "any", false, true), "level", array(), "any", true, true) && $this->getAttribute($this->getAttribute($this->getContext($context, "log", true), "context", array(), "any", false, true), "type", array(), "any", true, true)) && ((twig_constant("E_DEPRECATED") == $this->getAttribute($this->getAttribute($this->getContext($context, "log"), "context", array()), "type", array())) || (twig_constant("E_USER_DEPRECATED") == $this->getAttribute($this->getAttribute($this->getContext($context, "log"), "context", array()), "type", array()))))) {
                // line 109
                echo "        DEPRECATION -  ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "log"), "message", array()), "html", null, true);
                echo "
        ";
                // line 110
        ...
        ";
                // line 115
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getContext($context, "log"), "context", array()), "stack", array()));
            ...
            <li>Called from ";
                        // line 129
                        echo ((($this->getAttribute($context["call"], "file", array(), "any", true, true) && $this->getAttribute($context["call"], "line", array(), "any", true, true))) ? ($this->env->getExtension('code')->formatFile($this->getAttribute($context["call"], "file", array()), $this->getAttribute($context["call"], "line", array()), $this->getContext($context, "from"))) : ($this->getContext($context, "from")));
                        echo "</li>

            ";
                        // line 131
                        if (($context["index"] == (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "log"), "context", array()), "stack", array())) - 1))) {
                            // line 132
                            echo "                </ul>
            ";
                        }
                ...
                // line 136
                echo "        ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "log"), "priorityName", array()), "html", null, true);
                echo " - ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "log"), "message", array()), "html", null, true);
                echo "
        ";
                // line 137
                if (($this->getAttribute($this->getContext($context, "log", true), "context", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute($this->getContext($context, "log"), "context", array())))) {
                    // line 138
                    echo "            <br />
            <small>
                <strong>Context</strong>: ";
                    // line 140
                    echo twig_escape_filter($this->env, twig_jsonencode_filter($this->getAttribute($this->getContext($context, "log"), "context", array()), (64 | 256)), "html", null, true);
                    echo "
            </small>
        ";
                }
