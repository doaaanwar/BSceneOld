...
class __TwigTemplate_da84996a24650b370025b319c8ce538b9e9d863cc0f2eb1a37ac05e948d4d347 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        // line 6
        if ((50 < $this->getAttribute($this->getContext($context, "collector"), "querycount", array()))) {
        ...
        // line 10
        echo "        ";
        if (($this->getAttribute($this->getContext($context, "collector"), "invalidEntityCount", array()) > 0)) {
            // line 11
            echo "            <span class=\"sf-toolbar-info-piece-additional sf-toolbar-status sf-toolbar-status-red\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "invalidEntityCount", array()), "html", null, true);
            echo "</span>
        ";
        }
        // line 13
        echo "        ";
        if ($this->getAttribute($this->getContext($context, "collector"), "cacheEnabled", array())) {
            // line 14
        ...
        // line 28
        echo ((($this->getAttribute($this->getContext($context, "collector"), "invalidEntityCount", array()) > 0)) ? ("red") : ("green"));
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "invalidEntityCount", array()), "html", null, true);
        echo "</span>
        </div>
        ...
        if ($this->getAttribute($this->getContext($context, "collector"), "cacheEnabled", array())) {
            ...
            // line 33
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "cacheHitsCount", array()), "html", null, true);
            echo "</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>Cache misses</b>
                <span class=\"sf-toolbar-status sf-toolbar-status-";
            // line 37
            echo ((($this->getAttribute($this->getContext($context, "collector"), "cacheMissesCount", array()) > 0)) ? ("yellow") : ("green"));
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "cacheMissesCount", array()), "html", null, true);
            echo "</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>Cache puts</b>
                <span class=\"sf-toolbar-status sf-toolbar-status-";
            // line 41
            echo ((($this->getAttribute($this->getContext($context, "collector"), "cachePutsCount", array()) > 0)) ? ("yellow") : ("green"));
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "cachePutsCount", array()), "html", null, true);
            echo "</span>
            </div>
        ";
        }
...
$this->getContext($context, "token"), "panel" => "db", "connectionName" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 64
$this->getContext($context, "app"), "request", array()), "query", array()), "get", array(0 => "connection"), "method"), "query" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 65
$this->getContext($context, "app"), "request", array()), "query", array()), "get", array(0 => "query"), "method"))));
            // line 66
            echo "
    ";
        } else {
            ...
            <table class=\"alt\" id=\"queriesPlaceholder-";
                ...
                foreach ($context['_seq'] as $context["i"] => $context["query"]) {
                    ...
                    if ($this->getAttribute($context["query"], "explainable", array())) {
                        // line 125
                        echo "                                [<a href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_profiler", array("panel" => "db", "token" => $this->getContext($context, "token"), "page" => "explain", "connection" => $context["connection"], "query" => $context["i"])), "html", null, true);
    ...
    ";
        // line 147
        if ($this->getAttribute($this->getContext($context, "collector"), "connections", array())) {
            // line 148
            echo "        ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:table.html.twig")->display(array("data" => $this->getAttribute($this->getContext($context, "collector"), "connections", array())));
            // line 149
            echo "    ";
        } else {
            // line 150
    ...
    ";
        // line 157
        if ($this->getAttribute($this->getContext($context, "collector"), "managers", array())) {
            // line 158
            echo "        ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:table.html.twig")->display(array("data" => $this->getAttribute($this->getContext($context, "collector"), "managers", array())));
            // line 159
            echo "    ";
        } else {
            // line 160
    ...
    ";
        // line 167
        if ($this->getAttribute($this->getContext($context, "collector"), "cacheCounts", array())) {
            // line 168
            echo "        ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:table.html.twig")->display(array("data" => $this->getAttribute($this->getContext($context, "collector"), "cacheCounts", array())));
            // line 169
            echo "
        ";
            // line 170
            if ($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "cacheRegions", array()), "hits", array())) {
                // line 171
                echo "            <h3>Number of cache hits</h3>
            ";
                // line 172
                $this->env->loadTemplate("WebProfilerBundle:Profiler:table.html.twig")->display(array("data" => $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "cacheRegions", array()), "hits", array())));
                // line 173
                echo "        ";
            }
            // line 174
        ...
        ";
            // line 175
            if ($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "cacheRegions", array()), "misses", array())) {
                // line 176
                echo "            <h3>Number of cache misses</h3>
            ";
                // line 177
                $this->env->loadTemplate("WebProfilerBundle:Profiler:table.html.twig")->display(array("data" => $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "cacheRegions", array()), "misses", array())));
                // line 178
                echo "        ";
            }
            // line 179
        ...
        ";
            // line 180
            if ($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "cacheRegions", array()), "puts", array())) {
                // line 181
                echo "            <h3>Number of cache puts</h3>
            ";
                // line 182
                $this->env->loadTemplate("WebProfilerBundle:Profiler:table.html.twig")->display(array("data" => $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "cacheRegions", array()), "puts", array())));
                // line 183
                echo "        ";
            }
            // line 184
    ...
    ";
        // line 192
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "collector"), "entities", array()));
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["class"]) {
                    ...
                    echo "</td>
                        <td>
                            ";
                    // line 209
                    if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector", true), "mappingErrors", array(), "any", false, true), $context["manager"], array(), "array", false, true), $context["class"], array(), "array", true, true)) {
                        // line 210
                        echo "                                <ul>
                                    ";
                        // line 211
                        $context['_parent'] = (array) $context;
                        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "mappingErrors", array()), $context["manager"], array(), "array"), $context["class"], array(), "array"));
