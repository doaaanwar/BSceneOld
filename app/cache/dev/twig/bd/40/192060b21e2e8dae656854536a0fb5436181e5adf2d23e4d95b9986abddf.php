...
class __TwigTemplate_bd40192060b21e2e8dae656854536a0fb5436181e5adf2d23e4d95b9986abddf extends Twig_Template
{
    ...
    <form action=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["m"]) {
            // line 13
            echo "                <option";
            echo ((($context["m"] == $this->getContext($context, "method"))) ? (" selected=\"selected\"") : (""));
            echo ">";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "request"), "baseUrl", array()), "html", null, true);
        echo "\">
        <div class=\"clear-fix\"></div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["l"]) {
            // line 32
            echo "                <option";
            echo ((($context["l"] == $this->getContext($context, "limit"))) ? (" selected=\"selected\"") : (""));
            echo ">";
