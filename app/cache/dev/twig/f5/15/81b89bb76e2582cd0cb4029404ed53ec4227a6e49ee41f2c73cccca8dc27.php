...
class __TwigTemplate_f51581b89bb76e2582cd0cb4029404ed53ec4227a6e49ee41f2c73cccca8dc27 extends Twig_Template
{
...
";
    ...
    {
        // line 55
        if (((($this->getContext($context, "required") && (null === $this->getContext($context, "placeholder"))) &&  !$this->getContext($context, "placeholder_in_choices")) &&  !$this->getContext($context, "multiple"))) {
            // line 56
        ...
        if ( !(null === $this->getContext($context, "placeholder"))) {
            // line 60
            echo "<option value=\"\"";
            if (($this->getContext($context, "required") && twig_test_empty($this->getContext($context, "value")))) {
                echo " selected=\"selected\"";
            }
            echo ">";
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($this->getContext($context, "placeholder"), array(), $this->getContext($context, "translation_domain")), "html", null, true);
            echo "</option>";
        }
        // line 62
    ...
    public function block_date_widget($context, array $blocks = array())
    {
        ...
        if (($this->getContext($context, "widget") == "single_text")) {
            ...
            echo ">";
            // line 113
            echo strtr($this->getContext($context, "date_pattern"), array("{{ year }}" =>             // line 114
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "year", array()), 'widget'), "{{ month }}" =>             // line 115
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "month", array()), 'widget'), "{{ day }}" =>             // line 116
$this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "day", array()), 'widget')));
    ...
    public function block_button_widget($context, array $blocks = array())
    {
        ...
        if (twig_test_empty($this->getContext($context, "label"))) {
            // line 180
            if ( !twig_test_empty($this->getContext($context, "label_format"))) {
                // line 181
                $context["label"] = strtr($this->getContext($context, "label_format"), array("%name%" =>                 // line 182
$this->getContext($context, "name"), "%id%" =>                 // line 183
$this->getContext($context, "id")));
            } else {
                // line 186
    ...
    public function block_form_label($context, array $blocks = array())
    {
        ...
        if ( !($this->getContext($context, "label") === false)) {
            ...
            if (twig_test_empty($this->getContext($context, "label"))) {
                ...
                if ( !twig_test_empty($this->getContext($context, "label_format"))) {
                    // line 214
                    $context["label"] = strtr($this->getContext($context, "label_format"), array("%name%" =>                     // line 215
$this->getContext($context, "name"), "%id%" =>                     // line 216
$this->getContext($context, "id")));
                } else {
                    // line 219
                    $context["label"] = $this->env->getExtension('form')->humanize($this->getContext($context, "name"));
