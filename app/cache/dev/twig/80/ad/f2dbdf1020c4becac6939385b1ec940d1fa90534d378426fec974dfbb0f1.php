...
class __TwigTemplate_80adf2dbdf1020c4becac6939385b1ec940d1fa90534d378426fec974dfbb0f1 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 4
        echo "    ";
        if ($this->getAttribute($this->getContext($context, "collector"), "user", array())) {
            // line 5
            echo "        ";
            $context["color_code"] = ((($this->getAttribute($this->getContext($context, "collector"), "enabled", array()) && $this->getAttribute($this->getContext($context, "collector"), "authenticated", array()))) ? ("green") : ("yellow"));
            // line 6
            echo "        ";
            $context["authentication_color_code"] = ((($this->getAttribute($this->getContext($context, "collector"), "enabled", array()) && $this->getAttribute($this->getContext($context, "collector"), "authenticated", array()))) ? ("green") : ("red"));
            // line 7
            echo "        ";
            $context["authentication_color_text"] = ((($this->getAttribute($this->getContext($context, "collector"), "enabled", array()) && $this->getAttribute($this->getContext($context, "collector"), "authenticated", array()))) ? ("Yes") : ("No"));
            // line 8
            echo "    ";
        } else {
            // line 9
            echo "        ";
            $context["color_code"] = (($this->getAttribute($this->getContext($context, "collector"), "enabled", array())) ? ("red") : ("black"));
            // line 10
            echo "    ";
        }
        // line 11
        ...
        if ($this->getAttribute($this->getContext($context, "collector"), "user", array())) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "user", array()), "html", null, true);
            echo "</span>
            </div>
            ...
            ";
            // line 21
            if (($this->getAttribute($this->getContext($context, "collector"), "tokenClass", array()) != null)) {
                // line 22
                echo "            <div class=\"sf-toolbar-info-piece\">
                <b>Token class</b>
                ";
                // line 24
                echo $this->env->getExtension('code')->abbrClass($this->getAttribute($this->getContext($context, "collector"), "tokenClass", array()));
                echo "
            </div>
            ";
            }
            // line 27
            echo "        ";
        } elseif ($this->getAttribute($this->getContext($context, "collector"), "enabled", array())) {
            // line 28
        ...
        if ($this->getAttribute($this->getContext($context, "collector"), "user", array())) {
            ...
            <tr>
                ...
                <td>
                    ";
            // line 59
            if ($this->getAttribute($this->getContext($context, "collector"), "authenticated", array())) {
                // line 60
                echo "                        yes
                    ";
            } else {
                // line 62
                echo "                        no ";
                if ( !twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "roles", array()))) {
            ...
            <tr>
                ...
                <td>";
            // line 68
            echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->encode($this->getAttribute($this->getContext($context, "collector"), "roles", array())), "html", null, true);
            echo "</td>
            </tr>
            ";
            // line 70
            if (($this->getAttribute($this->getContext($context, "collector"), "tokenClass", array()) != null)) {
                ...
                <td>";
                // line 73
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "tokenClass", array()), "html", null, true);
                echo "</td>
            </tr>
            ";
            }
...
$this->getContext($context, "collector"), "enabled", array())) {
            // line 78
            echo "        <p>
            <em>No token</em>
        </p>
