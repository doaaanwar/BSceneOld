...
class __TwigTemplate_d22b073c2013d70d0930609fda5795263763ce1963b7d3999336f6ad5b1102a0 extends Twig_Template
{
    ...
    <div id=\"content\">
        ...
        if ($this->getContext($context, "profile")) {
            ...
            echo "\">View last 10</a>
                            ...
                            ";
            // line 18
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "method", array())), "html", null, true);
            echo "
                            ";
            // line 19
            if (twig_in_filter(twig_upper_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "method", array())), array(0 => "GET", 1 => "HEAD"))) {
                // line 20
                echo "                                <a href=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "url", array()), "html", null, true);
                echo "\" id=\"resume-url\">";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "url", array()), "html", null, true);
                echo "</a>
                            ";
            ...
            echo "                            <span class=\"date\">
                                <em>by ";
            // line 25
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "ip", array()), "html", null, true);
            echo "</em> at <em>";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "time", array()), "r"), "html", null, true);
            echo "</em>
                            </span>
                        </div>
                    ";
        ...
        if (array_key_exists("templates", $context)) {
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                echo "                                ";
                ob_start();
                echo twig_escape_filter($this->env, $this->getAttribute($context["template"], "renderBlock", array(0 => "menu", 1 => array("collector" => $this->getAttribute($this->getContext($context, "profile"), "getcollector", array(0 => $context["name"]), "method"))), "method"), "html", null, true);
                ...
                if (($this->getContext($context, "menu") != "")) {
                    ...
                    if (($context["name"] == $this->getContext($context, "panel"))) {
                        echo " selected";
                    }
                    echo "\">
                                        <a href=\"";
                    // line 42
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_profiler", array("token" => $this->getContext($context, "token"), "panel" => $context["name"])), "html", null, true);
                    echo "\">";
