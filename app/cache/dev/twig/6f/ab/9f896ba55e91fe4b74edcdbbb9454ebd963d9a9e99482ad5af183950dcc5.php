...
class __TwigTemplate_6fab9f896ba55e91fe4b74edcdbbb9454ebd963d9a9e99482ad5af183950dcc5 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 4
        echo "    ";
        if ($this->getAttribute($this->getContext($context, "collector"), "messageCount", array())) {
            // line 5
            echo "        ";
            ob_start();
            // line 6
            ...
            // line 7
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "messageCount", array()), "html", null, true);
            echo "</span>
        ";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "collector"), "mailers", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo "</b>
                    <span>";
                // line 18
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "messageCount", array(0 => $context["name"]), "method"), "html", null, true);
                echo "</span>
                </div>
                <div class=\"sf-toolbar-info-piece\">
                    <b>Is spooled ?</b>
                    <span>";
                // line 22
                echo (($this->getAttribute($this->getContext($context, "collector"), "isSpool", array(0 => $context["name"]), "method")) ? ("yes") : ("no"));
                echo "</span>
                </div>
            ";
            }
...
";
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            ...
            // line 54
            echo twig_escape_filter($this->env, $context["name"], "html", null, true);
            echo (($this->getAttribute($this->getContext($context, "collector"), "isDefaultMailer", array(0 => $context["name"]), "method")) ? (" (default mailer)") : (""));
            echo "</th>
                    <td>";
            // line 55
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "messageCount", array(0 => $context["name"]), "method"), "html", null, true);
            echo " ";
            echo (($this->getAttribute($this->getContext($context, "collector"), "isSpool", array(0 => $context["name"]), "method")) ? ("spooled") : ("sent"));
            echo "</td>
                </tr>
            ";
        }
    ...
    ";
        ...
        ";
            // line 64
            if ( !$this->getAttribute($this->getContext($context, "collector"), "messages", array(0 => $context["name"]), "method")) {
                // line 65
                echo "            <p>
        ...
        ";
                ...
                // line 70
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "collector"), "messages", array(0 => $context["name"]), "method"));
                $context['loop'] = array(
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                    ...
                    echo "                        <pre>";
                    // line 76
                    if (($this->getAttribute($this->getContext($context, "messagePart", true), "charset", array(), "any", true, true) && $this->getAttribute($context["message"], "charset", array()))) {
                        // line 77
